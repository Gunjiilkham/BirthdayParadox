...
def getBirthdays(numberOfBirtdays):
    """Returns a list of number random date objects for birthdays."""
    birthdays = []
    for i in range(numberOfBirtdays):
        #The year is unimportant for the simulation, as long as all
        #birtdays have the same year.
...
for i, birthday in enumerate(birthdays):
    if i != 0:
        #Display a comma for each birthday after the first birthdays.
        print(', ', end='')
